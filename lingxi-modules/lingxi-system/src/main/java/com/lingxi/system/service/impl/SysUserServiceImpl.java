...
import com.lingxi.common.core.utils.bean.BeanValidators;
import com.lingxi.common.datascope.annotation.DataScope;
...
public class SysUserServiceImpl implements ISysUserService
{
    ...
    @Override
    @Transactional
    public int updateEmployeeInfo(SysUser user)
    {
        return userMapper.updateEmployeeInfo(user);
    }
     ...
     */
    @Override
    public List<SysUser> selectUsersByRoleKey(String roleKey)
    {
     ...
     */
    @Override
    public List<SysUser> selectUsersByRoleKeyAndDept(String roleKey, Long deptId)
    {
        return userMapper.selectUsersByRoleKeyAndDept(roleKey, deptId);
    }
     ...
     */
    @Override
    public List<SysUser> selectActiveUserList()
    {
        return userMapper.selectActiveUserList();
    }
